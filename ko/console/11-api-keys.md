...
{% hint style="info" %}
💡 Publishable Key는 목록에서 항상 확인할 수 있으며, 키 값을 클릭하면 언제든 복사할 수 있습니다.
{% endhint %}
...
3. 전체 키 값이 강조 표시와 함께 한 번만 표시됩니다. 즉시 복사하세요.

{% hint style="danger" %}
🚨 **위험** — Secret Key 값은 생성 시 한 번만 표시됩니다. 페이지를 떠나면 마스킹된 값만 확인할 수 있습니다. 분실 시 삭제 후 새로 생성해야 합니다.
{% endhint %}
...
1. 목록에서 삭제할 키를 찾으세요.
2. **Delete** 버튼을 클릭하세요.
3. 확인 다이얼로그에서 키 이름을 입력하고 **삭제 확인**을 클릭하세요.
4. 즉시 해당 키가 무효화됩니다.
