...
{% hint style="info" %}
💡 `bkendFetch` 헬퍼를 사용하면 401 응답 시 자동으로 토큰을 갱신합니다. 자세한 내용은 [토큰 관리](../../../authentication/20-token-management.md)를 참고하세요.
{% endhint %}
...
{% hint style="info" %}
💡 MCP 설정에 대한 자세한 내용은 [MCP 개요](../../../mcp/01-overview.md)를 참고하세요.
{% endhint %}
...
- [에러 처리 가이드](../../../guides/11-error-handling.md) — 에러 코드 및 처리 패턴 상세
- [토큰 관리](../../../authentication/20-token-management.md) — 토큰 저장 및 자동 갱신 패턴
