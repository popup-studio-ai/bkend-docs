...
const features = [
  {
    ...
    description: "Browse, search, and manage products with categories and pricing.",
  },
  {
    icon: Package,
    title: "Order Tracking",
    description: "Place orders and track them through every stage of fulfillment.",
  },
  {
    icon: Star,
    title: "Reviews & Ratings",
    description: "Share your experience with ratings and detailed product reviews.",
  },
  {
    icon: Shield,
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-bold">bkend Mall</span>
            </div>
            ...
            <p className="text-lg text-white/80 mb-12 max-w-md">
              A full-featured shopping mall built on the bkend platform.
              Discover products, manage orders, and share reviews.
            </p>
          </motion.div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-background p-4 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold">bkend Mall</span>
          </div>
