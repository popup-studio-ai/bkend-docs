...
|-----------|-------------|----------|
| 인증 | 이메일 회원가입/로그인, 소셜 로그인 | [인증 개요](../authentication/01-overview.md) |
| 동적 테이블 | 데이터 CRUD, 필터링, 페이지네이션 | [데이터베이스 개요](../database/01-overview.md) |
| 스토리지 | 이미지/파일 업로드 | [스토리지 개요](../storage/01-overview.md) |
...
각 쿡북을 실제 배포한 데모입니다. 데모 계정(`demo@bkend.ai` / `Bkend123$`)으로 로그인하여 체험하세요.

| 쿡북 | 플랫폼 | 라이브 데모 |
|------|--------|-----------|
| 블로그 | Web | [bkend-blog.netlify.app](https://bkend-blog.netlify.app/) |
| 레시피 앱 | Web | [bkend-recipe.netlify.app](https://bkend-recipe.netlify.app/) |
| 쇼핑몰 | Web | [bkend-shopping-mall.netlify.app](https://bkend-shopping-mall.netlify.app/) |
| 소셜 네트워크 | iOS | [Appetize.io 시뮬레이터](https://appetize.io/app/ios/com.bkend.example.socialNetworkApp?device=iphone14pro&osVersion=17.2) |

👉 자세한 내용은 [라이브 데모](./live-demos.md) 페이지를 참고하세요.
