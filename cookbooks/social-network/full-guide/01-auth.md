...
{% hint style="info" %}
💡 인증은 사용자가 직접 앱에서 수행하는 작업입니다. MCP 도구로는 인증을 대신할 수 없습니다. 위의 REST API 탭을 참고하여 앱에 로그인 기능을 구현하세요.
{% endhint %}

인증이 완료된 후, AI 도구로 프로필 확인 등의 작업을 수행할 수 있습니다.
...
{% hint style="info" %}
💡 회원가입과 로그인은 사용자가 직접 앱에서 수행합니다. REST API 탭을 참고하여 구현하세요.
{% endhint %}
...
{% hint style="info" %}
💡 MCP 연결 시 토큰은 MCP 서버 설정에서 관리됩니다. 앱에서의 토큰 관리는 REST API 탭을 참고하세요.
{% endhint %}
