...
export const IMAGE_PRESETS = {
  /** Article card thumbnail (400x300) */
  thumbnail: { width: 400, height: 300, quality: 80, format: "webp" } as ImageTransform,
  /** Article detail cover (1200x630) */
  detail: { width: 1200, height: 630, quality: 85, format: "webp" } as ImageTransform,
  /** Related article small thumb (200x150) */
  small: { width: 200, height: 150, quality: 75, format: "webp" } as ImageTransform,
